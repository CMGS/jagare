...
class RevList(object):
    def get_rev_list(self, repository, to_ref, path, max_count=20, from_ref=None, author=None, skip=0):
...
class RevListView(MethodView):
    ...
    def get(self, repository, exists, to_ref):
        ...
        rev_list=RevList()
        return rev_list.get_rev_list(repository, to_ref, path, max_count, from_ref, author, skip)
